...
file_path = r'D:\CAPESTONE\Stunting\dataset_acak.csv'
...
model.fit(X_train_scaled, y_train, epochs=50000, batch_size=32, validation_split=0.2, callbacks=[early_stopping])
